...
def generate_launch_description():
    ...
    gz_server = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            ...
            )  # correct filename in ros_gz_sim ([github.com](https://github.com/gazebosim/ros_gz/blob/ros2/ros_gz_sim/launch/gz_server.launch.py?utm_source=chatgpt.com))
        ),
    ...
    gz_gui = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            ...
            )  # starts server and GUI ([gazebosim.org](https://gazebosim.org/docs/latest/ros2_launch_gazebo/?utm_source=chatgpt.com))
        ),
